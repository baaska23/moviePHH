    ...
    <footer className="bg-white dark:bg-gray-900">
      ...
      <div className="mx-auto w-full max-w-screen-xl px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 px-4 py-6 lg:py-8">
          {/* Links column: Үндсэн */}
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Үндсэн</h2>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Холбоос</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Бидний тухай</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
        ...
        <div className="px-4 py-6 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2024 <a href="https://flowbite.com/">ICinema™</a>. All Rights Reserved.
          </span>
        </div>
      </div>
    </footer>
